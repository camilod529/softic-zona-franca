    ...
    <div className="collapse navbar-collapse" id="navbarTogglerDemo02">
      ...
      {user.rol === 1 ? (
        ...
        {user.rol === 2 ? (
                <>
        <li className="nav-item">
          <Link className="nav-link active" aria-current="page" to={"/LinkdmColaboradores"}>Administrar colaboradores</Link>
        </li>
        <li className="nav-item">
        ...
        <li className="nav-item">
          <Link className="nav-link" to={"/miEmpresa"}>Mi empresa</Link>
        </li>
        <li className="nav-item">
